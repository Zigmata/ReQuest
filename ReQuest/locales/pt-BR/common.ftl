...
common-btn-prev = Ant.
common-btn-remove = Remover
common-btn-edit = Editar
common-btn-delete = Excluir
common-btn-select = Selecionar
common-btn-manage = Gerenciar
common-btn-rename = Renomear
common-btn-continue = Continuar
common-btn-cancel = Cancelar
common-btn-enable = Ativar
common-btn-disable = Desativar
...
common-label-free = Grátis
common-label-none = Nenhum
common-label-unknown = Desconhecido
...
common-day-wednesday = Quarta-feira
common-day-thursday = Quinta-feira
common-day-friday = Sexta-feira
