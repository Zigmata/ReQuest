...
admin-modal-label-shutdown-warning = ¡Advertencia! Esto apagará el bot. Escribe CONFIRM para continuar.
...
admin-select-placeholder-server = Selecciona un servidor para eliminar
