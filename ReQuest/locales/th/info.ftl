...
info-help-description =
    ...
    {"-"} Trade: ให้ไอเทมหรือสกุลเงินแก่ผู้เล่นคนอื่น
    {"-"} View Player (เฉพาะ GM): ดูคลังไอเทมของตัวละครที่ใช้งานอยู่ของผู้เล่นคนอื่น
    {"-"} Modify Player (เฉพาะ GM): แก้ไขคลังไอเทมหรือประสบการณ์ของตัวละครที่ใช้งานอยู่ของผู้เล่นคนอื่น
