...
gm-desc-player-management =
    ...
    - {"**"}Modify Player{"**"}: Додати або видалити предмети та досвід у гравця.
    - {"**"}View Player{"**"}: Переглянути деталі активного персонажа гравця.
...
gm-desc-remove-player-notes =
    ...
    - Якщо ви бажаєте нагородити гравця за попередній внесок, використовуйте контекстне меню `Modify Player`, щоб видати нагороди безпосередньо.
