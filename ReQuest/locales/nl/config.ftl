...
config-label-denomination-info = **{ $name }** (Waarde: { $value })
...
config-error-amount-exceeds-maximum = Het bedrag mag niet hoger zijn dan { $max }.
...
config-label-more-roles = (+{ $count } meer)
